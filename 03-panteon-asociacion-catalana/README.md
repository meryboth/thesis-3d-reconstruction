...
> Nombre corregido nuevamente (07/09): Panteón de la Asociación Catalana de Socorros Mutuos (Montepío de Montserrat) — la resolución del 01/09 (Asociación Española, arquitecto Christophersen) estaba mal; ese arquitecto y el Decreto 525/2010 son de un panteón distinto. Arquitecto candidato de este panteón: Santiago Barris, sin confirmar todavía. Pendiente: validar el arquitecto y el respaldo documental de patrimonio. La carpeta cruda de origen (`panteon-chacarita/panteon-asociacion-catalana/`) mantiene su nombre original — ver nota en el [README raíz](../README.md).
