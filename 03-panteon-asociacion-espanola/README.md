# 03 — Panteón Asociación Española (Panteón Chacarita)

> Nombre confirmado (01/09): Panteón de la Asociación Española de Socorros Mutuos, arquitecto Alejandro Christophersen (1896). La carpeta cruda de origen (`panteon-chacarita/panteon-asociacion-catalana/`) mantiene su nombre original — ver nota en el [README raíz](../README.md).
