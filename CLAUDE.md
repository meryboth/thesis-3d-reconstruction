...
`02-templete-central/03-datasets/hibrido/` — dataset DJI+Insta360 combinado (794 imágenes, 100% registradas), rescatado el 25/08 de un componente COLMAP que el wrapper de Nerfstudio había reportado como fallo casi total (ver `00-auditoria/`). El Panteón ya tiene el suyo en `03-panteon-asociacion-catalana/03-datasets/hibrido/`.
...
Cap. 7 (Conclusiones) ya fue reescrito por la usuaria: contrasta las cinco hipótesis una por una (7.2) y no queda nada de aquel borrador del 27/08.
