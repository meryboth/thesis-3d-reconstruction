...
**<u>5.1 Resumen de los benchmarks</u>**
...
**<u>5.2 B1 — Técnicas sobre el caso de referencia: Templete Central (H1)</u>**

**5.2.1 Métricas cuantitativas**
...
![Comparación Foto / Nerfacto / Splatfacto — Templete Central, DJI, vista elevada con ghosting en Splatfacto](../../00-auditoria/fidelidad-geometrica/02-templete-central/dji/comparacion_00924.jpg)
...
![Comparación Foto / Nerfacto / Splatfacto — Templete Central, DJI, quinto fotograma](../../00-auditoria/fidelidad-geometrica/02-templete-central/dji/comparacion_01228.jpg)
...
**5.2.2 Fidelidad geométrica — Nerfacto vs. Splatfacto vs. SfM**
...
**5.2.3 SfM — Malla texturizada y potencial de integración BIM**
...
![](media/2026-09-01-13-31-22-image.png)
...
![](media/2026-09-01-13-33-17-image.png)
...
**<u>5.3 B2 — Benchmark de preprocesamiento ComfyUI (H2)</u>**

**5.3.1 Comparación con dataset sin distractores**
...
![](media/2026-09-01-13-54-22-image.png)
...
**5.3.2 Evidencia visual del impacto del preprocesamiento**
...
**5.3.3 Pipeline de limpieza: nodos y decisiones de diseño**
...
**5.3.4 Resultado de la reconstrucción sobre el Dataset B — contraste de H2**
...
**5.3.5 Máscara de entrenamiento (aislamiento de fondo)**
...
![Render Nerfacto — Panteón Asociación Catalana, floaters](../../00-auditoria/fidelidad-geometrica/03-panteon-asociacion-catalana/dji/comparacion_frame_00714.jpg)
...
![](media/2026-09-01-16-22-50-image.png)
...
![](media/2026-09-01-16-25-50-image.png)
...
![Nube de puntos densa — Panteón Asociación Catalana, proyecciones XY/XZ](../../03-panteon-asociacion-catalana/02-resultados-finales/dji/colmap-fotogrametria/nube-densa-scatter.png)
...
![](media/2026-09-01-17-19-01-image.png)
...
![](media/2026-09-01-17-22-11-image.png)
...
![](media/2026-09-01-17-23-52-image.png)
...
**5.5.4 Evidencia complementaria: calidad de render por dispositivo**
...
**5.5.5 Resultado de reconstrucción sobre el dataset híbrido — contraste directo de H4**
...
**5.5.6 Segundo caso de estudio híbrido: reconstrucción completa del Panteón Asociación Catalana**
...
![Calidad de matching por tipo de par, Panteón Asociación Catalana](../../00-auditoria/hybrid-cross-camera-matching/hybrid-cross-camera-matching-chart-panteon.png)
...
![Comparación PSNR/SSIM/LPIPS, DJI vs. Insta360 vs. Híbrido, Panteón Asociación Catalana](../../00-auditoria/hibrido-comparison/hibrido_psnr_ssim_lpips_panteon.png)
...
**<u>5.11 Conclusiones del capítulo</u>**
