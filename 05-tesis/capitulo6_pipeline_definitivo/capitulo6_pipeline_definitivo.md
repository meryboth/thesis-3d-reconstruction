...
![Diagrama del Pipeline A: captura, SfM, segmentación geométrica y control de calidad humano (implementado y validado), seguidos de decimación, importación a Revit, modelado paramétrico y vínculo documental (propuesta conceptual)](media/pipeline-a-hbim.png)
